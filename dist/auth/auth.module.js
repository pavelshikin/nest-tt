...
AuthModule = __decorate([
    common_1.Module({
        ...
        providers: [auth_service_1.AuthService, jwt_refresh_token_strategy_1.JwtRefreshTokenStrategy],
        imports: [
            ...
            passport_1.PassportModule.register({ defaultStrategy: 'jwt-refresh-token' }),
        ],
        exports: [
