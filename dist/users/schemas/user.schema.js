...
__decorate([
    mongoose_1.Prop({ type: [{ type: mongoose.Schema.Types.ObjectId, ref: 'Track' }] }),
    __metadata("design:type", Array)
], User.prototype, "tracks", void 0);
__decorate([
    mongoose_1.Prop({ type: [{ type: mongoose.Schema.Types.ObjectId, ref: 'Post' }] }),
    __metadata("design:type", Array)
